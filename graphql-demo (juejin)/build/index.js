...
exports.updateOne = function (collectionName, data, targ, callback) {
  _connectDB((err, db) => db.collection(collectionName).updateOne(data, targ, (err, results) => {
    if (err) throw err; // console.log(targ);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  Mutation: {
    createUser: (parent, {
      ...
      age,
      gender
    }) => _db__WEBPACK_IMPORTED_MODULE_0___default.a.user({
      id
    }).then(existUser => {
      if (existUser) throw new Error('已经有这个id的人了');
    }).then(() => _db__WEBPACK_IMPORTED_MODULE_0___default.a.createUser({
      id,
      name,
      email,
      age,
    ...
    updateUser: (parent, {
      ...
      return existUser;
    }).then(() => _db__WEBPACK_IMPORTED_MODULE_0___default.a.updateUser({
      id,
      name,
      email,
      age,
    ...
    deleteUser: (parent, {
      ...
      return existUsers[0];
    }).then(user => new Promise(resolve => _db__WEBPACK_IMPORTED_MODULE_0___default.a.deleteUser(user).then(_ => resolve(user))))
  }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  Query: {
    users: (parent, args) => _db__WEBPACK_IMPORTED_MODULE_0___default.a.users({}),
    user: (parent, {
      id
    }) => _db__WEBPACK_IMPORTED_MODULE_0___default.a.user({
      id
...
/* harmony import */ var _Hello_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Hello.js */ "./src/resolvers/Hello.js");
/* harmony import */ var _Query_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Query.js */ "./src/resolvers/Query.js");
/* harmony import */ var _Mutation_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Mutation.js */ "./src/resolvers/Mutation.js");
/* harmony import */ var _Subscription_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Subscription.js */ "./src/resolvers/Subscription.js");
/**
 * 创建于 2019-03-10
 * 作者: SHERlocked93
 * 功能: resolvers 实现
...
/* harmony default export */ __webpack_exports__["default"] = (lodash_merge__WEBPACK_IMPORTED_MODULE_0___default()(PureObj, _Hello_js__WEBPACK_IMPORTED_MODULE_1__["default"], _Query_js__WEBPACK_IMPORTED_MODULE_2__["default"], _Mutation_js__WEBPACK_IMPORTED_MODULE_3__["default"], _Subscription_js__WEBPACK_IMPORTED_MODULE_4__["default"]));
